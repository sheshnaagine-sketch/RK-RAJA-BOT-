...
<head>
    ...
    <title>✨ RK RAJA BOTE PANLE ✨</title>
    <style>
        @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;700&display=swap');

        :root {
            --pink-primary: #ff4d8d;
            --pink-secondary: #ff80ab;
            --pink-light: #ffb6c1;
            --pink-dark: #c2185b;
            --purple-primary: #d500f9;
            --purple-secondary: #e040fb;
            --blue-primary: #2979ff;
            --blue-secondary: #448aff;
            --gold: #ffd700;
        }
        ...
        @keyframes rgbGlow {
            ...
            33% { 
                text-shadow: 
                    ...
                    0 0 15px var(--blue-primary),
                    0 0 20px var(--pink-primary);
            }
            66% { 
                text-shadow: 
                    0 0 5px #fff,
                    0 0 10px var(--blue-primary),
                    0 0 15px var(--pink-primary),
        ...
        ::-webkit-scrollbar-thumb {
            background: linear-gradient(45deg, var(--pink-primary), var(--purple-primary));
            border-radius: 10px;
        }
...
<body>
    ...
    <div class="title-container">
        <h1 class="sonam-barbie-title">✨ RK RAJA BOT PANEL ✨</h1>
    ...
    <form id="configForm">
        ...
        <button type="submit">Start Bot <span class="barbie-icon">👑</span></button>
    </form>

    <div class="container">
        <div class="box">
            <div class="headerBox">
                <h3>Bot Logs <span class="barbie-icon">📝</span></h3>
        ...
        <div class="box">
            <h3>Joined Groups <span class="barbie-icon">👥</span></h3>
            <div class="box-content">
                <ul id="groupsList"></ul>
            </div>
        </div>
        ...
        <div class="box">
            <h3><span class="barbie-icon">💖</span> BOT COMMANDS <span class="barbie-icon">💖</span></h3>
...
🆔 **ID DETAILS**:
  ...
  /uid <mention> ➡️ Get user ID.
            ...
            <div class="contact-info">
                <h3>👑 BOT ADMIN RK RAJA 👑</h3>
                <p>🌸 CONTACT: 917291868271 🌸</p>
